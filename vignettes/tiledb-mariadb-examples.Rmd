...
# Database: mysql [@localhost:NA/test]
 ...
 9             208        1
10             255        1
> # here to request is actually send as SQL and the computation is done in the SQL layer
> tbl(con, "/work/trip_data_1") %>% group_by(passenger_count) %>% summarize(nobs = n()) %>% show_query()
<SQL>
...
This short vignette demonstrates the use TileDB-stored data from R using
