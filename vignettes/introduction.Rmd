...
`library(tiledb)`. Installation is supported for Windows, Linux and
macOS via the [official CRAN
package](https://cran.r-project.org/package=tiledb), on Linux and macOS
via the [conda](https://anaconda.org/conda-forge) package as well as
from source.
...
[introductory
notebook](https://github.com/TileDB-Inc/TileDB-R/blob/master/inst/notebooks/).
...
available in the
[examples](https://github.com/TileDB-Inc/TileDB-R/tree/master/inst/examples)
...
See the script
[ex_S3.R](https://github.com/TileDB-Inc/TileDB-R/blob/master/inst/examples/ex_S3.R)
for an example.
...
[ex_1.R](https://github.com/TileDB-Inc/TileDB-R/blob/master/inst/examples/ex_1.R)
...
[quickstart_dense.R](https://github.com/TileDB-Inc/TileDB-R/blob/master/inst/examples/quickstart_dense.R)
by adding a second and third attribute. In this as well as the following
examples we will use `tiledb_array()` to access the array; the older
variants `tiledb_dense()` and `tiledb_sparse()` remain supported but are
...
attributes can be selected via the `attrs` argument, or the `attrs()`
...
[ex_2.R](https://github.com/TileDB-Inc/TileDB-R/blob/master/inst/examples/ex_2.R)
