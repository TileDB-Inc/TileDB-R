...
Additional documentation for the TileDB R package is available via the `help()` function from within
R as well as via the [package documentation](https://tiledb-inc.github.io/TileDB-R/) and an
[introductory notebook](https://tiledb-inc.github.io/TileDB-R/documentation.nb.html). Documentation
about TileDB itself is [also available](https://docs.tiledb.com/main/).
