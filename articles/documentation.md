...
examples](https://docs.tiledb.com/main/how-to). A shorter [introductory
vignette](https://tiledb-inc.github.io/TileDB-R/articles/introduction.md)
is also available.

## Prelimaries

We will show two initial and basic examples for a dense and sparse array
simply to create array data on disk to refer to later in examples that
follow.
