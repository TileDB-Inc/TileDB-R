...
// libtiledb_query_set_buffer_inject_offsets
void libtiledb_query_set_buffer_inject_offsets(IntegerVector vec, NumericVector doffsets);
RcppExport SEXP _tiledb_libtiledb_query_set_buffer_inject_offsets(SEXP vecSEXP, SEXP doffsetsSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerVector >::type vec(vecSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type doffsets(doffsetsSEXP);
    libtiledb_query_set_buffer_inject_offsets(vec, doffsets);
    return R_NilValue;
END_RCPP
}
// libtiledb_query_set_buffer_var_char_helper
std::string libtiledb_query_set_buffer_var_char_helper(SEXP val, NumericVector origoffset);
RcppExport SEXP _tiledb_libtiledb_query_set_buffer_var_char_helper(SEXP valSEXP, SEXP origoffsetSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(libtiledb_query_set_buffer_var_char_helper(val, origoffset));
    return rcpp_result_gen;
END_RCPP
}
...
// libtiledb_query_set_buffer_var_df_helper
SEXP libtiledb_query_set_buffer_var_df_helper(SEXP val, NumericVector origoffset);
RcppExport SEXP _tiledb_libtiledb_query_set_buffer_var_df_helper(SEXP valSEXP, SEXP origoffsetSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type val(valSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type origoffset(origoffsetSEXP);
    rcpp_result_gen = Rcpp::wrap(libtiledb_query_set_buffer_var_df_helper(val, origoffset));
    return rcpp_result_gen;
END_RCPP
}
...
// libtiledb_query_set_buffer_varlength
XPtr<tiledb::Query> libtiledb_query_set_buffer_varlength(XPtr<tiledb::Query> query, std::string attr, SEXP buffer, NumericVector doffsets);
RcppExport SEXP _tiledb_libtiledb_query_set_buffer_varlength(SEXP querySEXP, SEXP attrSEXP, SEXP bufferSEXP, SEXP doffsetsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< XPtr<tiledb::Query> >::type query(querySEXP);
    ...
    Rcpp::traits::input_parameter< SEXP >::type buffer(bufferSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type doffsets(doffsetsSEXP);
    rcpp_result_gen = Rcpp::wrap(libtiledb_query_set_buffer_varlength(query, attr, buffer, doffsets));
    return rcpp_result_gen;
END_RCPP
}
// libtiledb_query_result_list_column
Rcpp::List libtiledb_query_result_list_column(XPtr<tiledb::Query> query, std::string storagemode, std::string attr, SEXP buffer, NumericVector doffsets);
RcppExport SEXP _tiledb_libtiledb_query_result_list_column(SEXP querySEXP, SEXP storagemodeSEXP, SEXP attrSEXP, SEXP bufferSEXP, SEXP doffsetsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< XPtr<tiledb::Query> >::type query(querySEXP);
    Rcpp::traits::input_parameter< std::string >::type storagemode(storagemodeSEXP);
    Rcpp::traits::input_parameter< std::string >::type attr(attrSEXP);
    Rcpp::traits::input_parameter< SEXP >::type buffer(bufferSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type doffsets(doffsetsSEXP);
    rcpp_result_gen = Rcpp::wrap(libtiledb_query_result_list_column(query, storagemode, attr, buffer, doffsets));
    return rcpp_result_gen;
END_RCPP
}
...
// libtiledb_query_result_buffer_elements_offsets
R_xlen_t libtiledb_query_result_buffer_elements_offsets(XPtr<tiledb::Query> query, std::string attribute);
RcppExport SEXP _tiledb_libtiledb_query_result_buffer_elements_offsets(SEXP querySEXP, SEXP attributeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< XPtr<tiledb::Query> >::type query(querySEXP);
    Rcpp::traits::input_parameter< std::string >::type attribute(attributeSEXP);
    rcpp_result_gen = Rcpp::wrap(libtiledb_query_result_buffer_elements_offsets(query, attribute));
    return rcpp_result_gen;
END_RCPP
}
...
// libtiledb_array_max_buffer_elements_offsets
R_xlen_t libtiledb_array_max_buffer_elements_offsets(XPtr<tiledb::Array> array, SEXP subarray, std::string attribute);
RcppExport SEXP _tiledb_libtiledb_array_max_buffer_elements_offsets(SEXP arraySEXP, SEXP subarraySEXP, SEXP attributeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< XPtr<tiledb::Array> >::type array(arraySEXP);
    Rcpp::traits::input_parameter< SEXP >::type subarray(subarraySEXP);
    Rcpp::traits::input_parameter< std::string >::type attribute(attributeSEXP);
    rcpp_result_gen = Rcpp::wrap(libtiledb_array_max_buffer_elements_offsets(array, subarray, attribute));
    return rcpp_result_gen;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type debug(debugSEXP);
    rcpp_result_gen = Rcpp::wrap(write_varlength_array(uri, listobject, names, debug));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_tiledb_libtiledb_query_set_buffer_var_df_helper", (DL_FUNC) &_tiledb_libtiledb_query_set_buffer_var_df_helper, 2},
    {"_tiledb_libtiledb_query_set_buffer_var_vec_helper", (DL_FUNC) &_tiledb_libtiledb_query_set_buffer_var_vec_helper, 2},
    {"_tiledb_libtiledb_query_set_buffer_varlength", (DL_FUNC) &_tiledb_libtiledb_query_set_buffer_varlength, 4},
    ...
    {"_tiledb_libtiledb_query_result_buffer_elements_offsets", (DL_FUNC) &_tiledb_libtiledb_query_result_buffer_elements_offsets, 2},
    ...
    {"_tiledb_libtiledb_array_max_buffer_elements_offsets", (DL_FUNC) &_tiledb_libtiledb_array_max_buffer_elements_offsets, 3},
