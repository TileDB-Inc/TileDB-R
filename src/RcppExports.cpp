...
// libtiledb_vfs_open
Rcpp::XPtr<vfs_fh_t> libtiledb_vfs_open(XPtr<tiledb::Context> ctxxp, XPtr<tiledb::VFS> vfsxp, std::string uri, std::string mode);
...
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< XPtr<tiledb::Context> >::type ctxxp(ctxxpSEXP);
    Rcpp::traits::input_parameter< Rcpp::XPtr<vfs_fh_t> >::type fh(fhSEXP);
    libtiledb_vfs_close(ctxxp, fh);
    return R_NilValue;
END_RCPP
}
// libtiledb_vfs_write
void libtiledb_vfs_write(XPtr<tiledb::Context> ctxxp, Rcpp::XPtr<vfs_fh_t> fh, Rcpp::IntegerVector vec);
...
// libtiledb_vfs_read
Rcpp::IntegerVector libtiledb_vfs_read(XPtr<tiledb::Context> ctxxp, Rcpp::XPtr<vfs_fh_t> fh, double offset, double nbytes);
