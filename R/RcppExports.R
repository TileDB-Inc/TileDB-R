...
has_array_metadata <- function(array_name, key) {
    .Call(`_tiledb_has_array_metadata`, array_name, key)
}

num_array_metadata <- function(array_name) {
    .Call(`_tiledb_num_array_metadata`, array_name)
}

read_array_metadata <- function(array_name, key) {
