...
has_metadata <- function(array_name, key) {
    .Call(`_tiledb_has_metadata`, array_name, key)
}

num_metadata <- function(array_name) {
    .Call(`_tiledb_num_metadata`, array_name)
}

read_metadata <- function(array_name, key) {
    .Call(`_tiledb_read_metadata`, array_name, key)
}

write_metadata <- function(array_name, key, obj) {
    .Call(`_tiledb_write_metadata`, array_name, key, obj)
}
