...
fixup_coord_buffer <- function(v) {
    invisible(.Call(`_tiledb_fixup_coord_buffer`, v))
}
...
libtiledb_query_buffer_sparse_coords_alloc <- function(array, domaintype, ncells) {
    .Call(`_tiledb_libtiledb_query_buffer_sparse_coords_alloc`, array, domaintype, ncells)
}
