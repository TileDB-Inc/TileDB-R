...
.allocate_arrow_array_as_double <- function() {
    .Call(`_tiledb_allocate_arrow_array_as_double`)
}

.allocate_arrow_schema_as_double <- function() {
    .Call(`_tiledb_allocate_arrow_schema_as_double`)
}

.delete_arrow_array_from_double <- function(dbl) {
    invisible(.Call(`_tiledb_delete_arrow_array_from_double`, dbl))
}

.delete_arrow_schema_from_double <- function(dbl) {
    invisible(.Call(`_tiledb_delete_arrow_schema_from_double`, dbl))
}

libtiledb_query_export_buffer <- function(queryxp, name) {
    .Call(`_tiledb_libtiledb_query_export_buffer`, queryxp, name)
}

libtiledb_query_import_buffer <- function(queryxp, name, arrowpointers) {
    .Call(`_tiledb_libtiledb_query_import_buffer`, queryxp, name, arrowpointers)
}
