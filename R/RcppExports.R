...
libtiledb_query_buffer_assign_ptr <- function(buf, dtype, vec, useRType = TRUE, castDatetime = TRUE) {
    .Call(`_tiledb_libtiledb_query_buffer_assign_ptr`, buf, dtype, vec, useRType, castDatetime)
}
